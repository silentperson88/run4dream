...
const generateScriptValidator = [
  ...
  body("extraInfo")
    ...
    .isLength({ max: 4000 })
    .withMessage("extraInfo must be up to 4000 characters"),
  body("context")
    .optional()
    .isString()
    .withMessage("context must be a string")
    .isLength({ max: 4000 })
    .withMessage("context must be up to 4000 characters"),
  body("platform")
    .optional()
    .isString()
...
const generateSceneAudiosValidator = [
  ...
  body("scenes.*.narration")
    ...
    .withMessage("scene narration must be between 1 and 10000 characters"),
  body("scenes.*.text")
    .optional()
    .isString()
    .withMessage("scene text must be a string")
    .isLength({ min: 1, max: 10000 })
    .withMessage("scene text must be between 1 and 10000 characters"),
  body("language")
    .optional()
    .isIn(["en", "hi"])
